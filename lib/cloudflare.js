...
// const getWorkerDomainsByAccount = async (accountId) => cloudflareGet(`/accounts/${accountId}/workers/domains`, false);
// const getWorkerDomainById = async (accountId, domainId) => cloudflareGet(`/accounts/${accountId}/workers/domains/${domainId}`, true);
